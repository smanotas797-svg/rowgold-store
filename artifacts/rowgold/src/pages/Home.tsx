...
function HeroSection() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(160deg, #040404 0%, #0c0900 45%, #060606 100%)",
      }}
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 90% 70% at 60% 40%, rgba(212,175,55,0.06) 0%, transparent 65%)",
        }}
      />
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background:
            "radial-gradient(ellipse 50% 80% at 15% 80%, rgba(180,120,0,0.04) 0%, transparent 60%)",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          height: 1,
          background:
            "linear-gradient(90deg, transparent 0%, rgba(212,175,55,0.06) 30%, rgba(212,175,55,0.12) 50%, rgba(212,175,55,0.06) 70%, transparent 100%)",
        }}
      />
          ...
          >
            <Link href="/catalog">
              <motion.button
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #9a7808, #d4af37, #f0cc50, #d4af37, #9a7808)",
                  color: "#050505",
                  letterSpacing: "0.2em",
                  fontSize: "0.65rem",
          ...
          >
            <Link href={`/product/${hero.id}`}>
              ...
              >
                {/* Outer glow */}
                <div
                  className="absolute -inset-6 rounded-sm opacity-0 group-hover:opacity-100 transition-opacity duration-600 pointer-events-none"
                  style={{
                    background:
                ...
                >
                  ...
                  >
                    ...
                    {/* Badge */}
                    <div
                      className="absolute top-4 left-4 px-3 py-1 text-[9px] tracking-[0.22em] uppercase"
                      style={{
  ...
  return (
    ...
    >
      <Link href={`/product/${product.id}`}>
        <div
          className="luxury-card overflow-hidden transition-all duration-500 hover:border-gold relative"
        ...
        >
          ...
          <div
            ...
            style={{
              aspectRatio: "3/4",
              background: "linear-gradient(135deg, #0e0e0e, #181500)",
            }}
          >
            {product.imageUrl ? (
              <img
              ...
              <div
                className="w-full h-full flex items-center justify-center"
                style={{
                  background: "linear-gradient(135deg, #0e0e0e, #1a1500)",
                }}
              >
            ...
            >
              <span
                className="text-[10px] tracking-[0.3em] uppercase px-5 py-2.5"
                style={{
            ...
            {product.collection && (
              <div
                className="absolute top-3 left-3 px-2.5 py-0.5 text-[8px] tracking-widest uppercase"
                style={{
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="luxury-card aspect-[3/4] rounded-sm animate-pulse"
            />
          ))}
        </div>
      ) : (
...
const JEWELRY_SECTIONS = [
  {
    ...
    eyebrow: "Colección",
    description:
      "Piezas eternas que simbolizan los momentos más importantes de tu vida.",
    image:
  ...
  },
  {
    ...
    eyebrow: "Oro & Plata",
    description:
      "Cadenas artesanales de oro 18k y plata 925 con acabado espejo.",
    image:
  ...
  },
  {
    ...
    eyebrow: "Brillo",
    description:
      "Desde argollas minimalistas hasta statement earrings con diamantes.",
    image:
      ...
      <Link href={section.href}>
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col justify-end p-7">
            ...
            <p
              className="text-xs leading-relaxed mb-5 max-w-xs opacity-0 group-hover:opacity-100 transition-opacity duration-400"
              style={{
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <span
                className="text-[10px] tracking-[0.25em] uppercase transition-colors duration-300 group-hover:text-amber-400"
                style={{ color: "rgba(212,175,55,0.5)" }}
              >
                Explorar
              </span>
...
function JewelrySections() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(180deg, #060606 0%, #090700 50%, #060606 100%)",
      }}
    >
      <div className="max-w-7xl mx-auto">
        <SectionHeader
          eyebrow="Nuestra Joyería"
...
function CategoryGrid() {
  ...
  const categoryImages: Record<string, string> = {
    joyas:
      "https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=700&q=85",
    relojes:
      "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=700&q=85",
    accesorios:
      "https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=700&q=85",
    colecciones:
      "https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=700&q=85",
  };
  ...
  return (
    <section
      ...
      className="py-24 px-6 lg:px-8"
      style={{
        background: "linear-gradient(180deg, #0a0900 0%, #060606 100%)",
      }}
    >
      <div className="max-w-7xl mx-auto">
        <SectionHeader
              ...
              <Link href={`/catalog?category=${cat.slug}`}>
                ...
                >
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-end pb-7 px-4 text-center">
                    ...
                    <p
                      className="text-[10px] mt-1.5 tracking-[0.2em]"
                      style={{ color: "rgba(212,175,55,0.55)" }}
                    >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          {badges.map((b, i) => (
            ...
            >
              <div
                className="w-14 h-14 mx-auto mb-5 flex items-center justify-center transition-all duration-400 group-hover:scale-110"
                style={{
                  border: "1px solid rgba(212,175,55,0.2)",
...
function BrandStatement() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(135deg, #080600 0%, #0e0a00 50%, #080600 100%)",
      }}
    >
      <motion.div
        initial={{ opacity: 0 }}
        ...
        style={{
          background:
            "radial-gradient(ellipse 70% 55% at 50% 50%, rgba(212,175,55,0.055) 0%, transparent 68%)",
        }}
      />
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        >
          "Cada pieza que creamos lleva el peso de la historia y la precisión
          del futuro."
        </motion.blockquote>
        <motion.div
          initial={{ scaleX: 0 }}
