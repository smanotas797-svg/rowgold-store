      ...
      >
        ...
        <div className="text-center mb-10">
          <motion.div animate={{ y: [0, -6, 0] }} transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}>
            <img src={rowgoldLogo} alt="ROWGOLD" className="w-20 h-20 object-contain mx-auto mb-4" />
          </motion.div>
          <h1
            style={{
        ...
        <div className="luxury-card p-10">
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <motion.button
              ...
              className="w-full py-4 text-xs tracking-[0.25em] uppercase font-semibold disabled:opacity-60"
              style={{ background: "linear-gradient(135deg, #b8960c, #d4af37, #b8960c)", color: "#080808" }}
            >
              {form.formState.isSubmitting ? "Iniciando..." : "Iniciar Sesion"}
            </motion.button>
          </form>
