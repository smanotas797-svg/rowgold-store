...
export default function Profile() {
  ...
  if (!user) {
    return (
      <div
        className="min-h-screen pt-24 flex items-center justify-center px-6"
        style={{ background: "#060606" }}
      >
        <motion.div
          ...
          <div className="flex flex-col gap-3">
            <Link href="/login">
              <motion.button
                ...
                className="w-full py-3.5 text-xs tracking-[0.25em] uppercase font-semibold"
                style={{
            ...
            <Link href="/register">
              <button
                className="w-full py-3.5 text-xs tracking-[0.25em] uppercase transition-all"
                style={{
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            {ordersLoading ? (
              ...
              <div className="text-center py-20">
                ...
                <Link href="/catalog">
                  <button
                    className="mt-6 px-10 py-3 text-xs tracking-[0.25em] uppercase transition-all hover:border-amber-400/50"
          ...
          >
            <div className="luxury-card p-8">
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  className="text-xs tracking-wider flex items-center gap-1.5 transition-colors hover:text-amber-400"
                  style={{ color: "rgba(255,255,255,0.3)" }}
                >
            ...
            <div className="luxury-card p-8">
              ...
              >
                ...
                <button
                  className="text-xs tracking-wider transition-colors hover:text-amber-400"
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p
                        ...
                        style={{ color: "rgba(255,255,255,0.3)" }}
                      >
                        Gestionar productos, pedidos y más
                      </p>
                    </div>
                  </div>
                  <ChevronRight
